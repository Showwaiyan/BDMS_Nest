...
export class CreateRequestDto {
  ...
  @ApiProperty({ enum: BloodGroup, example: BloodGroup.O_POS, description: 'Required blood group' })
  @IsEnum(BloodGroup)
  @IsNotEmpty()
  ...
  @ApiProperty({ enum: UrgencyLevel, example: UrgencyLevel.high, description: 'Urgency level of the request' })
  @IsEnum(UrgencyLevel)
  @IsNotEmpty()
  ...
  @ApiProperty({ example: 'Surgery requirement', description: 'Reason for the blood request' })
  @IsString()
  @IsNotEmpty()
  reason: string;
}
